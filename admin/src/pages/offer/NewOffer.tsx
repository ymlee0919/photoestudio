...
const NewOffer = () => {
    ...
    return <>
        ...
        { !stores.categoriesStore.content || stores.categoriesStore.content.length == 0 ? 
        <div className="content-center text-center">
            <br></br>
            <br></br>
            <p>No categories found. Please, insert the offers categories</p>
            <br></br>
            <NavLink to='/categories' className="btn btn-primary btn-outline">Handle categories</NavLink>
        </div> : 
